        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 402.0, 150.0, 31.0, 22.0 ],
                    "text": "sig~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 345.0, 150.0, 31.0, 22.0 ],
                    "text": "sig~"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 413.0, 105.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 369.0, 59.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 2,
                    "numoutlets": 0,
                    "patching_rect": [ 294.0, 298.0, 45.0, 45.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 275.41, 86.41, 44.0, 22.0 ],
                    "text": "noise~"
                }
            },
            {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "signal" ],
                                    "patching_rect": [ 114.0, 133.0, 94.0, 23.0 ],
                                    "rnbo_classname": "clip~",
                                    "rnbo_serial": 6,
